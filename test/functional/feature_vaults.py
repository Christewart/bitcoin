...
from test_framework.script import OP_0, OP_1, OP_1NEGATE, OP_2, OP_2DUP, OP_3, OP_5, OP_6, OP_7, OP_ADD, OP_DROP, OP_DUP, OP_ELSE, OP_ENDIF, OP_EQUAL, OP_EQUALVERIFY, OP_GREATERTHAN, OP_IF, OP_INOUT_AMOUNT, OP_PICK, OP_ROLL, OP_SWAP, OP_VERIFY, CScript, OP_VAULT, OP_VAULT_RECOVER
