...
class Arithmetic64bitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        def check_neg(a, res, fail=None):
            self.tapscript_satisfy_test(CScript([OP_NEGATE, OP_VERIFY, le8(res), OP_EQUAL]), inputs = [le8(a)], fail=fail)
        # Arithematic opcodes
        ...
        self.tapscript_satisfy_test(CScript([le8(100), OP_CHECKLOCKTIMEVERIFY, OP_DROP, OP_1]),locktime=100)
