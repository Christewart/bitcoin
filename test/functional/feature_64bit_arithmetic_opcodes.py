...
from test_framework.script import OP_0, OP_1ADD, OP_1SUB, OP_8, OP_ABS, OP_ADD, OP_DIV, OP_DROP, OP_GREATERTHAN, OP_GREATERTHANOREQUAL, OP_LESSTHAN, OP_LESSTHANOREQUAL, OP_MAX, OP_MIN, OP_MUL, OP_NUMEQUAL, OP_NUMEQUALVERIFY, OP_NUMNOTEQUAL, OP_SIZE, OP_SUB, CScript, CScriptNum, CScriptOp, OP_1, OP_NEG64, OP_DUP, OP_EQUAL, OP_EQUALVERIFY, OP_VERIFY, taproot_construct, SIGHASH_DEFAULT, SIGHASH_ALL, SIGHASH_NONE, SIGHASH_SINGLE, SIGHASH_ANYONECANPAY, LEAF_VERSION_TAPSCRIPT_64BIT
...
class Arithmetic64bitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.tapscript_satisfy_test(CScript([le8(max), OP_ABS, OP_1, OP_EQUALVERIFY, le8(max), OP_EQUAL]))
        self.tapscript_satisfy_test(CScript([le8(min), OP_ABS, OP_0, OP_EQUALVERIFY, OP_DROP, OP_1]))
        self.tapscript_satisfy_test(CScript([le8(min + 1), OP_ABS, OP_1, OP_EQUALVERIFY, le8(max), OP_EQUAL]))
        self.tapscript_satisfy_test(CScript([OP_0, OP_ABS, OP_1, OP_EQUALVERIFY, OP_0, OP_EQUAL]))
