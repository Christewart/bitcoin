        ...
        for (; pc < pend; ++opcode_pos) {
            ...
            switch (opcode)
            {
                ...
                case OP_IN_AMOUNT:
                {
                    ...
                    CScriptNum bn1 = GetCScriptNum(stacktop(-1), fRequireMinimal, sigversion);
                    if (bn1 < bnZero) {
                ...
                case OP_OUT_AMOUNT:
                {
                    ...
                    popstack(stack);
                    std::vector<unsigned int> output_idxs = ParseBitMap(bn1);
                    int64_t spendingAmount = 0;
